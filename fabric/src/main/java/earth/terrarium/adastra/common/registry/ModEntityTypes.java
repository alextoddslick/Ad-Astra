...
public class ModEntityTypes {
    ...
    private static ResourceKey<EntityType<?>> key(String name) {
        return ResourceKey.create(Registries.ENTITY_TYPE, Identifier.fromNamespaceAndPath(AdAstra.MOD_ID, name));
    }
    ...
    public static final RegistryEntry<EntityType<LunarianWanderingTrader>> LUNARIAN_WANDERING_TRADER = ENTITY_TYPES.register("lunarian_wandering_trader", () ->
        EntityType.Builder.of(LunarianWanderingTrader::new, MobCategory.CREATURE)
            .sized(0.6f, 1.95f)
            .fireImmune()
            .build(key("lunarian_wandering_trader")));
    ...
    public static void registerSpawnPlacements() {
        ...
        try {
            ...
            method.invoke(null, ModEntityTypes.STAR_CRAWLER.get(), SpawnPlacementTypes.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (SpawnPlacements.SpawnPredicate<StarCrawler>) StarCrawler::checkMonsterSpawnRules);
            method.invoke(null, ModEntityTypes.MARTIAN_RAPTOR.get(), SpawnPlacementTypes.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (SpawnPlacements.SpawnPredicate<MartianRaptor>) MartianRaptor::checkMonsterSpawnRules);
            method.invoke(null, ModEntityTypes.PYGRO.get(), SpawnPlacementTypes.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (SpawnPlacements.SpawnPredicate<Pygro>) Pygro::checkMonsterSpawnRules);
            method.invoke(null, ModEntityTypes.ZOMBIFIED_PYGRO.get(), SpawnPlacementTypes.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (SpawnPlacements.SpawnPredicate<ZombifiedPygro>) ZombifiedPygro::checkMonsterSpawnRules);
            method.invoke(null, ModEntityTypes.PYGRO_BRUTE.get(), SpawnPlacementTypes.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (SpawnPlacements.SpawnPredicate<PygroBrute>) PygroBrute::checkMonsterSpawnRules);
            method.invoke(null, ModEntityTypes.MOGLER.get(), SpawnPlacementTypes.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (SpawnPlacements.SpawnPredicate<Mogler>) Mogler::checkMobSpawnRules);
            method.invoke(null, ModEntityTypes.ZOMBIFIED_MOGLER.get(), SpawnPlacementTypes.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (SpawnPlacements.SpawnPredicate<ZombifiedMogler>) ZombifiedMogler::checkMonsterSpawnRules);
