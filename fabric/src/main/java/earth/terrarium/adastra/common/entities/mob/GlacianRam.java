...
public class GlacianRam extends Animal implements Shearable {
    ...
    public GlacianRam(EntityType<? extends GlacianRam> entityType, Level level) {
        ...
        // TODO 26.1.2: PathType.DANGER_POWDER_SNOW removed.
    }

    public static AttributeSupplier.Builder createMobAttributes() {
        // TEMPT_RANGE was added in 1.21+ and is required by TemptGoal#canUse — vanilla
        // animals get it via Animal.createAnimalAttributes(), but this ram was built off
        // Mob.createMobAttributes() and was missing it. Every AI tick threw
        // IllegalArgumentException once the player landed on Glacio.
    ...
    public InteractionResult mobInteract(Player player, InteractionHand hand) {
        ...
        if (itemStack.is(Items.BUCKET) && !this.isBaby()) {
            ...
            if (actionResult.consumesAction() && this.isFood(itemStack)) {
                this.level().playSound(null, this, this.getEatingSound(), SoundSource.NEUTRAL, 1.0f, Mth.randomBetween(this.level().getRandom(), 0.8f, 1.2f));
            }
