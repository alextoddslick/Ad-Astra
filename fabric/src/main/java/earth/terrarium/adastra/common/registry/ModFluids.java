...
public final class ModFluids {
    ...
    public static final RegistryEntry<Fluid> CRYO_FUEL = FLUIDS.register("cryo_fuel", () -> new ResourcefulFlowingFluid.Still(ModFluidProperties.CRYO_FUEL.get()));
    public static final RegistryEntry<Fluid> FLOWING_CRYO_FUEL = FLUIDS.register("flowing_cryo_fuel", () -> new ResourcefulFlowingFluid.Flowing(ModFluidProperties.CRYO_FUEL.get()));
}
