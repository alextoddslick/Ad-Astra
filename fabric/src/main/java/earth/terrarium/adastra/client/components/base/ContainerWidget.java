...
public abstract class ContainerWidget extends AbstractContainerEventHandler implements Renderable, LayoutElement, NarratableEntry {
    ...
    // 1.26.1.2: Renderable#render was replaced with extractRenderState. Same per-frame call
    // shape — we still forward to each child renderable so nested widgets keep rendering.
    @Override
