...
public class SensorApp implements Ti69App {
    ...
    public void render(PoseStack pose, MultiBufferSource bufferSource, Matrix4f matrix4f, Font font, ClientLevel level, boolean rightHanded) {
        ...
        font.drawInBatch(oxygen, 12, 17, 0xFFFFFF, false, matrix4f, bufferSource, Font.DisplayMode.NORMAL, 0xFFFFFF, 15728880);
        font.drawInBatch(temperature, 12, 30, 0xFFFFFF, false, matrix4f, bufferSource, Font.DisplayMode.NORMAL, 0xFFFFFF, 15728880);
        font.drawInBatch(gravity, 12, 43, 0xFFFFFF, false, matrix4f, bufferSource, Font.DisplayMode.NORMAL, 0xFFFFFF, 15728880);
