...
public final class AdAstraClientEvents {
    ...
    public interface RenderSolarSystemEvent {
        ...
        void render(GuiGraphicsExtractor graphics, @Nullable Identifier solarSystem, int width, int height);
        ...
        @ApiStatus.Internal
        static void fire(GuiGraphicsExtractor graphics, @Nullable Identifier solarSystem, int width, int height) {
